...
public class Stage3 : MonoBehaviour
{
    ...
    public int stage = 3; // 게임스테이지
    float floormax = 30; //층 개수
    Color SafeColor = new Color(94 / 255f, 140 / 255f, 245 / 255f);
    Color DangerColor = new Color(250 / 255f, 51 / 255f, 111 / 255f);
    int emptynum = 3;   //구멍 개수
    int dangernum = 6;  //밟으면 안되는 면적 
