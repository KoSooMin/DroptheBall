...
public class Stage1 : MonoBehaviour
{
    ...
    public int stage = 1; // 게임스테이지
    float floormax = 10; //층 개수
    Color SafeColor = new Color(255 / 255f, 194 / 255f, 37 / 255f);
    Color DangerColor = new Color(179 / 255f, 86 / 255f, 221 / 255f);
    int emptynum = 5;   //구멍 개수
    int dangernum = 2;  //밟으면 안되는 면적 
